...
\begin{figure}
    ...
    \caption{Spatial maps of winter (DJF) concentration differences between scenarios (no nuclear - normal). We see the largest differences in \ce{NO_x} and \ce{SO_2} concentrations in the Northeast, leading to large differences in \ce{PM_{2.5}} as well. Winter ozone levels are not included.} 
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{ego_nonuclear_project/Figures/}
    \caption{Spatial maps of summer (JJA) concentration differences between scenarios (no nuclear - normal). We see the largest differences in \ce{NO_x} and \ce{SO_2} concentrations in the Northeast, leading to large differences in \ce{PM_{2.5}} and ozone in the region as well.} 
